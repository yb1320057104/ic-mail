...
func TestExtractOTP(t *testing.T) {
	tests := []struct {
		...
		{name: "japanese fullwidth", text: "お客様の確認コードは ６９１２８８ です。", want: "691288"},
		{name: "vietnamese", text: "Mã xác minh của bạn là 482193. Không chia sẻ mã này.", want: "482193"},
		...
		{name: "ambiguous unlabeled numbers rejected", text: "Values 123456 and 654321", want: ""},
		...
		{name: "forwarded date before real code", text: "转发：你的临时 ChatGPT 登录代码\n发件人：ChatGPT <noreply@example.com> · 2026-08-14 19:40\nEnter this temporary verification code to continue: 691288", want: "691288"},
		{name: "forwarded chinese date before real code", text: "你的 ChatGPT 登录代码\n发送时间：2026年8月14日 19:40\n验证码：A7B-9K2", want: "A7B-9K2"},
